...
- (NSString *)detailInfo {
    ...
    [detailString appendFormat:@"\tTarget File Create Time: %@\n", _targetFileCreateTime];
    [detailString appendFormat:@"\tTarget File Path: %@\n", _targetFilePath];
    [detailString appendFormat:@"\tAccess Mode: %@\n", _mode];
    [detailString appendFormat:@"}"];
...
- (NSString *)detailInfo {
    ...
    [detailString appendFormat:@"\tNew File Access Time: %@\n", _aTime];
    [detailString appendFormat:@"\tNew File Modification Time: %@\n", _mTime];
...
- (instancetype)initWithCoder:(NSCoder *)decoder {
    if (self = [super initWithCoder:decoder]) {
        DECODE_FILE_PROPERTY(target)
        _aTime = [decoder decodeObjectForKey:@"aTime"];
        _mTime = [decoder decodeObjectForKey:@"mTime"];
    }
    return self;
}
...
- (void)encodeWithCoder:(NSCoder *)encoder {
    [super encodeWithCoder:encoder];
    ENCODE_FILE_PROPERTY(target)
    [encoder encodeObject:_aTime forKey:@"aTime"];
    [encoder encodeObject:_mTime forKey:@"mTime"];
}
...
- (instancetype)initWithCoder:(NSCoder *)decoder {
    if (self = [super initWithCoder:decoder]) {
        DECODE_FILE_PROPERTY(target)
        _fcntlCmd = [decoder decodeObjectForKey:@"fcntlCmd"];
    }
    return self;
}
...
- (void)encodeWithCoder:(NSCoder *)encoder {
    [super encodeWithCoder:encoder];
    ENCODE_FILE_PROPERTY(target)
    [encoder encodeObject:_fcntlCmd forKey:@"fcntlCmd"];
}
...
- (NSString *)detailInfo {
    ...
    [detailString appendFormat:@"\tTarget Process Signing ID: %@\n", _targetSigningID];
    [detailString appendFormat:@"\tTarget Process Team ID: %@\n", _targetTeamID];
    [detailString appendFormat:@"\tProc Check Type: %@\n", _checkType];
    [detailString appendFormat:@"\tFlavor: %@\n", _flavor];
    [detailString appendFormat:@"}"];
...
- (instancetype)initWithCoder:(NSCoder *)decoder {
    if (self = [super initWithCoder:decoder]) {
        DECODE_PROCESS_PROPERTY(target)
        _checkType = [decoder decodeObjectForKey:@"checkType"];
        _flavor = [decoder decodeObjectForKey:@"flavor"];
    }
    return self;
}
...
- (void)encodeWithCoder:(NSCoder *)encoder {
    [super encodeWithCoder:encoder];
    ENCODE_PROCESS_PROPERTY(target)
    [encoder encodeObject:_flavor forKey:@"flavor"];
    [encoder encodeObject:_checkType forKey:@"checkType"];
}
...
- (NSString *)detailInfo {
    ...
    [detailString appendFormat:@"\tTarget Process Signing ID: %@\n", _targetSigningID];
    [detailString appendFormat:@"\tTarget Process Team ID: %@\n", _targetTeamID];
    [detailString appendFormat:@"\tResume Type: %@\n", _resumeType];
    [detailString appendFormat:@"}"];
...
- (instancetype)initWithCoder:(NSCoder *)decoder {
    if (self = [super initWithCoder:decoder]) {
        DECODE_PROCESS_PROPERTY(target)
        _resumeType = [decoder decodeObjectForKey:@"resumeType"];
    }
    return self;
}
...
- (void)encodeWithCoder:(NSCoder *)encoder {
    [super encodeWithCoder:encoder];
    ENCODE_PROCESS_PROPERTY(target)
    [encoder encodeObject:_resumeType forKey:@"resumeType"];
}
